...
export async function getGames({
  ...
  const params = {
    select:
      "id,name,slug,affiliate_url,meta_store_url,image_path,current_price,original_price,currency,release_date,created_at,rating,review_count,pricing_type,affiliate_discount_percent,affiliate_discount_active,first_iap_discount_percent,krw_price,usd_price,krw_converted_price,krw_store_available,region_restricted,motion_sickness_level,beginner_recommended,advanced_recommended,zecole_recommended,popularity_score,base_affiliate_discount_percent,promo_affiliate_discount_percent,promo_starts_at,promo_ends_at,promo_label",
    active: "eq.true",
    order,
    limit,
    offset,
  ...
  if (releasedOnly) params.release_date = "not.is.null";
...
export async function getHorizonPlus() {
  const { data } = await restSelect(
    ...
    {
      select:
        "id,month,category,external_game_name,note,game_id,game:games(id,name,slug,affiliate_url,meta_store_url,image_path,current_price,original_price,currency,release_date,created_at,rating,review_count,pricing_type,affiliate_discount_percent,affiliate_discount_active,first_iap_discount_percent,krw_price,usd_price,krw_converted_price,krw_store_available,region_restricted,motion_sickness_level,beginner_recommended,advanced_recommended,zecole_recommended,popularity_score,base_affiliate_discount_percent,promo_affiliate_discount_percent,promo_starts_at,promo_ends_at,promo_label)",
