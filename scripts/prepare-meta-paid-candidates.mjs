...
const fields = ["id", "meta_product_id", "name", "slug", "meta_store_url", "current_price", "original_price", "currency", "krw_price", "usd_price", "source_image_url", "image_path", "source_status", "release_date", "developer", "publisher", "supports_korean", "meta_store_original_price", "meta_store_offer_ends_at", "meta_store_show_timer"];
