...
// zecole.store에서 실제로 필요한 최대 썸네일 크기 — 상세페이지 히어로 이미지(.detail-image,
// 컨테이너 최대 1540px 안에서 16:9 비율로 표시)가 가장 큰 사용처라, 2배 레티나까지 감안해도
// 1600px면 어디서도 흐려 보이지 않는다. 메타 CDN 원본이 이보다 크면 업로드 전에 줄인다
// (2026-09-09, game_media/게임 상세정보 주기 갱신 작업 중 추가 — 그 전까진 원본 그대로
// 저장해서 Storage 용량을 불필요하게 많이 썼다).
